...
const StrokeText = ({
  ...
  const numFontSize = typeof fontSize === 'number' ? fontSize : 80;
  ...
  const fontStyle = useMemo(
    () => ({
      ...
      fontFamily: "var(--font-sporty, 'Poppins', sans-serif)",
      fontStyle: 'italic',
  ...
  const viewBox = box ? `${box.x} ${box.y} ${box.width} ${box.height}` : `0 ${-numFontSize} 700 ${numFontSize * 1.3}`;
