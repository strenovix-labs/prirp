...
headers = {
    ...
    "Neon-Connection-String": "postgresql://neondb_owner:npg_42vTohGxKSsP@ep-wandering-voice-ax3dccyv-pooler.c-4.us-east-2.aws.neon.tech/neondb?sslmode=require"
}

body = json.dumps({"query": "SELECT 1;"}).encode("utf-8")
